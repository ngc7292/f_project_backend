...
class getInfo():
    ...
    def getRelationFromCompany(self, c_name):
        ...
        for serve in c_serves:
            ...
            if checkTime(time_s):
                res_data['eage'].append(get_eage_temp(1, serve[0].identity, serve[2].identity, dict(serve[1])))
        ...
        for hold in c_holds:
            res_data['eage'].append(get_eage_temp(2, hold[0].identity, hold[2].identity, dict(hold[1])))
